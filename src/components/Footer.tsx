...
export default function Footer() {
  return (
    <footer className="bg-[var(--primary-950)] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-[var(--primary-200)] max-w-md">
              ...
              tools, prompt engineering, and build real-world projects in our
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/"
                  className="text-[var(--primary-200)] hover:text-[var(--accent-coral)] transition-colors"
                >
                  Home
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-[var(--primary-200)]">
        ...
        <div className="border-t border-[var(--primary-800)] mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a
              href="#"
              className="text-[var(--primary-300)] hover:text-[var(--accent-coral)] transition-colors"
              aria-label="Twitter"
            >
